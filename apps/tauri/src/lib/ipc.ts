 ...
 */
export type SnapshotOptionsInput = { include_html: boolean; include_accessibility_tree: boolean; include_performance_timing: boolean; include_computed_styles: boolean; include_network_metadata?: boolean }
/**
